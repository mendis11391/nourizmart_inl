...
class NotificationsListController extends GetxController {
  ...
  defaultApiCall() async {
    if (await checkInternetConnection()) {
      ...
      apiCallNotificationList(false);
    } else {
      await resetLoading(AppConstants.appZeroDuration);
    }
  }

  apiCallNotificationList(bool isPagination) async {
    if (!isPagination) {
      responseList.clear();
    }
    ...
    try {
      ...
      handleApiException(e, 'Notification List');
    }
  }
